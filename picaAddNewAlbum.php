...
<div class="wrap nosubsub">
	...
	<div id="mydiv" style="display: none; width: 500px; background: #fff;">
		<form method="POST" action="" onSubmit="return validateKey()">
			...
			<div align="center">
				<input type="text" name="get_license" id="get_license" size="58"
					value="" /> <input type="submit" name="submit_license"
					id="submit_license" value="Save" />
			</div>
		</form>
	</div>
...
<?php } //else { ?>
	...
	<div name="form_album" name="left_content" class="left_column">
		<form name="macAlbum" method="POST" id="macAlbum"
			enctype="multipart/form-data">
			<div class="form-wrap">

				<div class="form-macAlbum">
					<label for="macAlbum_name" style="cursor: none;">Album Name</label>
					<input name="macAlbum_name" id="macAlbum_name" type="text" value=""
						size="40" aria-required="true" />
					<div id="error_alb_name" style="color: red"></div>
					<p>
					<?php _e('The album name is how it appears on your site.'); ?>
					</p>

				</div>

				<div class="form-macAlbum">
					<label for="macAlbum_description" style="cursor: none;">Album
						Description</label>
					<textarea name="macAlbum_description" id="macAlbum_description"
						rows="5" cols="30"></textarea>
					<p>
					<?php _e('The description is for the album.'); ?>
					</p>
				</div>
				<!-- Gallery functionality written by Ishak -->

				<p class="submit">
					<input type="submit" onclick="return vaildateAlbumFields1()"
						class="button" name="macAlbum_submit" id="macAlbum_submit1"
						value="<?php echo 'Add new Album'; ?>" /></a>
				</p>
	...
	<div class="right_column">
		<form name="all_action" id="all_action" action="" method="POST"
			onSubmit="return deleteAlbums();">
			<div class="alignleft actions">
				...
				</select> <input type="submit" value="<?php esc_attr_e('Apply'); ?>"
					name="doaction_album" id="doaction_album"
					class="button-secondary action"
					onclick="return checkemptyaction('all_action')" /> <span
					id="ApplybutErroMsg" style="color: red;"></span>
...
<?php
require_once( dirname(__FILE__).'/picaAblumsTable.php');?>
			<script type="text/javascript">

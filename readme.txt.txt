...
Tested up to: 3.2.1
Stable tag: 2.5
PICA is a photo gallery extension which shows up your photos in an impressive and memorable way. The gallery extension easily organizes your large set of digital photos, edit images and create multiple albums. 
== Description ==
...
= Basic Installation =
1. Download the current version of the PICA Photo Gallery plugin go to Plugins --> click on add new --> upload -->select pica-photo-gallery.zip --> install.
...
PICA Photo Gallery have a  easy shortcode[picaGallery] to add in your blogs or pages. PICA Photo Gallery gives your friends the ability to resize your photos, download full-resolution pictures and they can share your photos by using  Facebook share
...
Please visit the forum for technical answers. If you don't find the answers you can post your questions there for others to answer your queries - PICA Photo Gallery Technical Support.
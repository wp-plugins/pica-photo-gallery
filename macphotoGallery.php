		...
		<?php
		 ...
		 ?>
   		<img
			...
			width="100" height="100"  alt="album Image " />
...
alert('jhhh');
	...
	function displaySelectedAlbum(idval , pageurl){
		...
		window.location = pageurl+'albid='+idval;
				...
				<table cellspacing="0" cellpadding="0" border="1"
					...
					$limit = 20;
				    $sql = mysql_query("SELECT * FROM " . $wpdb->prefix . "picaphotos WHERE macAlbum_id='$albid' AND is_delete = 0 ORDER BY macPhoto_sorting ");
					...
					/* Now we use the LIMIT clause to grab a range of rows */
					 ...
					 $result = $wpdb->get_results("SELECT * FROM " . $wpdb->prefix . "picaphotos WHERE macAlbum_id='$albid' AND is_delete =0   ORDER BY macPhoto_sorting DESC $w ");
    ...
    <input type="submit" name="updatePhoto_name" value="Update" onclick="updPhotoname('.$results->macPhoto_id.')">' ;
                              $album .= " </span>
                    ...
                    <a id='$site_url/wp-content/plugins/$folder/images/default_star.gif' class='preview' alt='Edit'  href='javascript:void(0)'>
                     <img src='$site_url/wp-content/plugins/$folder/images/default_star.gif' width='40' height='20' /></a></td>";
							} else
							{
								...
								$album .="<td  style='width:10%;align=center'>
                    <a id='$site_url/wp-content/uploads/pica-photo-gallery/$results->macPhoto_image' class='preview' alt='Edit' href='javascript:void(0)'>
                    <img src='$site_url/wp-content/uploads/pica-photo-gallery/$results->macPhoto_image' width='40' height='20' /></a></td>";
							...
							<div id='albumCove_bind_$results->macPhoto_id' style='text-align:center'>
						...
						if ($results->macFeaturedCover)
							{
								$album .= "<td align='center'><div id='albumCover_bind_$results->macPhoto_id' style='text-align:center'>
                            <img src='$site_url/wp-content/plugins/$folder/images/tick.png' width='16' height='16' style='cursor:pointer;text-align:center' onclick=macAlbcover_status('0',$albid,$results->macPhoto_id,1) /></div></td>";
							} else
							{
								$album .= "<td align='center'>
							<div id='albumCove_bind_$results->macPhoto_id' style='text-align:center'>
                            <img src='$site_url/wp-content/plugins/$folder/images/publish_x.png' width='16' height='16' style='cursor:pointer;text-align:center' onclick=macAlbcover_status('1',$albid,$results->macPhoto_id,1) /></div>
                            </td>";
							}
